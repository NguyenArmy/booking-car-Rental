            ...
            className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor'>
                <div >
                    ...
                    className='max-w-80 mt-3'>
                       Premium car retal service with a wide selection of luxury and everydat vehicles for all your driving needs.</motion.p>
                    <motion.div
                    initial={{ opacity: 0}}
                    whileInView={{ opacity: 1}}
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        ...
                        <li>Nam Chinh, Thai Binh cu, Hung Yen</li>
                        <li>+84 979 528 698</li>
